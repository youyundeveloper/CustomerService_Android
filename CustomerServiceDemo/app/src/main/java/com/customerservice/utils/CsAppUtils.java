...
public class CsAppUtils {
    ...
    public static String headUrl = "http://avatar.csdn.net/6/A/5/1_y331271939.jpg"; // 头像

    public static String CUSTOM_SERVICE_ID; // 客服ID
    public static final String CUSTOM_SERVICE_FIXED_ID = "607423";
    public static final String CUSTOM_SERVICE_FIXED_ID_TEST = "652747";
