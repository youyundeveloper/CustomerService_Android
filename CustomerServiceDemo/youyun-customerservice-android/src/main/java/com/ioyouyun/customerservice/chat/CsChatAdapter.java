...
import com.ioyouyun.customerservice.chat.imagemask.CsMaskView;
import com.ioyouyun.customerservice.chat.jsonmodel.CsActionMsgEntity;
import com.ioyouyun.customerservice.chat.jsonmodel.CsCardMsgEntity;
import com.ioyouyun.customerservice.chat.jsonmodel.CsJsonParentEntity;
import com.ioyouyun.customerservice.chat.jsonmodel.CsLinkMsgEntity;
import com.ioyouyun.customerservice.chat.jsonmodel.CsNoticeMsgEntity;
import com.ioyouyun.customerservice.chat.jsonmodel.CsTextMsgEntity;
import com.ioyouyun.customerservice.chat.model.CsChatEntity;
import com.ioyouyun.customerservice.chat.model.CsFileEntity;
import com.ioyouyun.customerservice.utils.CsAppUtils;
import com.youyun.customerservice.R;
...
public class CsChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void showHead(final ImageView imageView, Object resource){
        Glide.with(context)
                ...
                .asBitmap()
                .centerCrop()
                .placeholder(R.drawable.cs_people_default)
                .error(R.drawable.cs_people_default)
    ...
    private void showDatas(CsChatEntity entity, RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof PeopleTextHolder) {
            ...
            if(entity.headUrl != null && entity.headUrl.startsWith("http")) {
                ...
                showHead(robotTextHolder.avatarImage, R.drawable.cs_people_default);
            if (entity.isShowTime) {
            ...
            if(entity.headUrl != null && entity.headUrl.startsWith("http")) {
                ...
                showHead(robotImageHolder.avatarImage, R.drawable.cs_people_default);
            final CsFileEntity csFileEntity = entity.csFileEntity;
            Bitmap bitmap = BitmapFactory.decodeFile(csFileEntity.thumbnailPath);
            CsMaskView imgView = new CsMaskView(context, bitmap,
